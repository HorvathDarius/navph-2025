...
public class YemeMazeManager : MonoBehaviour
{
    ...
    IEnumerator SpawnDrinkRoutine()
    {
        ...
        spawnedDrink = Instantiate(drinkPrefab, spawnedShelf.position + new Vector3(1.5f, 0.2f, 0), Quaternion.identity);
        Instantiate(drinkPrefabVoid, spawnedShelf.position + new Vector3(1.5f, 0.2f, 0), Quaternion.identity);
    }
